defmodule Noizu.AdvancedScaffolding.Test.Fixture.V3.DomainObject.Schema do
  ...
  Noizu.AdvancedScaffolding.DomainObject.noizu_scaffolding_schema(app: :noizu_advanced_scaffolding, base_prefix: Noizu, database_prefix: Noizu.AdvancedScaffolding.Database) do
