...
defmodule Noizu.Scaffolding.V2.EntityBehaviourPolySupport do
  ...
  def id(m, ref) do
    ...
    case ref do
      ...
      } -> MapSet.member?(m.poly_support(), s) && identifier
  ...
  def ref(m, ref) do
    ...
    case ref do
      ...
      } -> MapSet.member?(m.poly_support(), s) && {:ref, b, identifier}
  ...
  def entity(m, ref, options) do
    ...
    case ref do
      ...
      } -> MapSet.member?(m.poly_support(), s) && ref.entity
      # type error
      %{__struct__: ^m} -> ref
      %{__struct__: ^b} -> ref
      # type error
      %{__struct__: s} -> MapSet.member?(m.poly_support(), s) && ref
      # type error
      v ->
        v = m.id(v)
        if v do
