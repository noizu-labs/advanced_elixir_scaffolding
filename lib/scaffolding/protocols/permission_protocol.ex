...
defprotocol Noizu.AdvancedScaffolding.Permission.Protocol do
...
#-------------------------------------------------------------------------------
defimpl Noizu.AdvancedScaffolding.Permission.Protocol, for: List do
  def has_permission?(entities, permission, context, options \\ nil) do
    for obj <- entities do
      Noizu.AdvancedScaffolding.Permission.Protocol.has_permission?(obj, permission, context, options)
    end
  end
...
defimpl Noizu.AdvancedScaffolding.Permission.Protocol, for: Tuple do
